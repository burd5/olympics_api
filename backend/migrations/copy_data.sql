...
\copy events (event, sport) FROM 'backend/data/events.csv' DELIMITER ',' CSV HEADER NULL '';
...
\copy results (athlete_id, team, games, event, medal) FROM 'backend/data/results.csv' DELIMITER ',' CSV HEADER NULL '';